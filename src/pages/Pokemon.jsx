            ...
            <div className="pokedexTop">
              <div className="pokedexTopLeft">
                ...
                <div className="circleArray">
                  <div id="first" className="smallCircle" />
                  <div id="second" className="smallCircle" />
                  <div id="third" className="smallCircle" />
                </div>
              </div>
              <div className="pokedexTopRight" />
            ...
            <div className="bottomDisplay">
              ...
              <div className="displayMid">
                <div className="midTopButtons">
                  <div className="midTopButton" />
                  <div id="blue" className="midTopButton" />
                </div>
                <div className="midBottomButton" />
              </div>
              <div className="displayRight">
                <div className="xButtonLayer1" />
                <div className="xButtonLayer2" />
              </div>
            </div>
          </div>
        </div>
